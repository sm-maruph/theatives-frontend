...
const AdminShowcase = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editingBlog) {
        // If editing, send PUT request (you'll need to create updateBlog service)
    ...
    <div className="admin-blog-wrapper">
      <div className="blog-container">
        <div className="blog-row">
            ...
            <div className="card-scroll-content">
              ...
              >
                ...
                <select
                  name="category"
                  id="category"
                  value={category} // Controlled component (recommended)
                ...
                <div style={{ marginBottom: "15px" }}>
                  {["heading", "paragraph", "list", "image", "video"].map(
                    (type) => (
                      <button
                        key={type}
          ...
          {/* Existing Blogs Card - RIGHT SIDE */}
          <div className="blog-card">
            <div className="card-header">
              <h3>Existing Showcase Post </h3>
            </div>
            <div className="card-scroll-content">
